...
LOGFILE=/noipupdater/logdir/noip.log
STOREDIPFILE=/noipupdater/configdir/current_ip

LOGDIR=/noipupdater/logdir             # best to use full absolute path (because of crontab integration)
CONFIGDIR=/noipupdater/configdir       # best to use full absolute path (because of crontab integration)
